...
$(document).ready(function() {
	...
	<body>
		<fieldset>
		<legend>Registration Form c</legend>
		<center>
		<form:form commandName="user" action="/CatalogoYanbalArq/app/registration/add" name="userForm">
		...
		<c:if test="${!empty users}">
			...
			<br />
			<center>
				<table id="example" width="90%" class="display compact" >
				   <thead>
